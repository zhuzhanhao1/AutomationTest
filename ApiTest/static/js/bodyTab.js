...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="../../temptlates/search.html"><i class="layui-icon" data-icon="&#xe68e;"></i><cite style="color: #ffffff">首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
